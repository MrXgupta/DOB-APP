        ...
        <>
            <div className="w-full max-w-2xl bg-slate-800 rounded-lg p-4 mt-6 shadow-lg">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-3" onSubmit={handleAddEmployee}>
                    <input type="text" name="code" placeholder="Code" className="p-2 bg-slate-700 border border-slate-600 rounded" />
                    <input type="text" name="name" placeholder="Name" className="p-2 bg-slate-700 border border-slate-600 rounded" />
                    <input type="date" name="dob" className="p-2 bg-slate-700 border border-slate-600 rounded" />
                    <input type="text" name="mobile" placeholder="Mobile" className="p-2 bg-slate-700 border border-slate-600 rounded" />
                    <button
                        type="submit"
